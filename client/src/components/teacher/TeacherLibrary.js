    ...
    <Container maxWidth="xl" sx={{ py: 3 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Browse and request books for teaching and research purposes
        </Typography>
      </Box>
      ...
      >
        <DialogTitle sx={{ 
          ...
          <RequestIcon />
          Request Book for Teaching/Research
        </DialogTitle>
        <DialogContent sx={{ p: 3 }}>
          {selectedBook && (
            <Box>
              <Alert severity="info" sx={{ mb: 3 }}>
                You are about to request this book for teaching and research purposes. 
                Teachers typically get extended borrowing periods and priority access.
              </Alert>
              ...
              <Alert severity="success" sx={{ mt: 2 }}>
                ...
                <br />• Extended borrowing period (30 days)
                <br />• Priority processing of requests
                <br />• Renewal options available
              </Alert>
            </Box>
          )}
        </DialogContent>
