    ...
    <Container maxWidth="xl" sx={{ py: 3 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#1a237e', mb: 1 }}>
          Training Officer Library Portal
        </Typography>
        <Typography variant="body1" color="text.secondary">
          Browse and request books for administrative and training purposes
        </Typography>
      </Box>
          ...
          <Card sx={{ 
            ...
            <CardContent>
              <Box display="flex" alignItems="center" justifyContent="space-between">
                ...
                <LibraryBooksIcon sx={{ fontSize: 40, opacity: 0.8 }} />
              </Box>
            </CardContent>
          </Card>
        </Grid>
          ...
          <Card sx={{ 
            ...
            <CardContent>
              <Box display="flex" alignItems="center" justifyContent="space-between">
                <Box>
                  <Typography variant="h4" sx={{ fontWeight: 'bold' }}>
                    ₹{fines.reduce((total, fine) => total + (fine.amount || 0), 0)}
                  </Typography>
                  <Typography variant="body2" sx={{ opacity: 0.9 }}>
                    Total Fines
                  </Typography>
      ...
      >
        <DialogTitle sx={{ 
          ...
          <RequestIcon />
          Request Book for Training/Administration
        </DialogTitle>
        <DialogContent sx={{ p: 3 }}>
          {selectedBook && (
            <Box>
              <Alert severity="info" sx={{ mb: 3 }}>
                You are about to request this book for training and administrative purposes. 
                Training Officers get priority access and extended borrowing periods.
              </Alert>
              
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                <Avatar sx={{ bgcolor: '#7b1fa2', mr: 2, width: 56, height: 56 }}>
                  <BookIcon />
                </Avatar>
                <Box>
              ...
              <Alert severity="success" sx={{ mt: 2 }}>
                <strong>Training Officer Benefits:</strong>
                <br />• Extended borrowing period (45 days)
                <br />• Highest priority processing
                <br />• Multiple renewal options
                <br />• Administrative access privileges
              </Alert>
            </Box>
          )}
        </DialogContent>
