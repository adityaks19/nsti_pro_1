    ...
    <Container maxWidth="xl" sx={{ py: 3 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" sx={{ fontWeight: 'bold', color: '#7b1fa2', mb: 1 }}>
          Training Officer Store Portal
        </Typography>
        <Typography variant="body1" color="text.secondary">
          Request store items for training and administrative purposes
        </Typography>
      </Box>
      ...
      {tabValue === 1 && (
        <Card>
          <CardContent>
            <Typography variant="h6" sx={{ mb: 3, fontWeight: 'bold', color: '#7b1fa2' }}>
              My Store Requests
            </Typography>
          ...
          {selectedItem && (
            <Box>
              <Alert severity="info" sx={{ mb: 3 }}>
                You are about to request this item for training and administrative purposes. 
              ...
              <TextField
                ...
                placeholder="Please specify the purpose for requesting this item (e.g., training session, administrative work, etc.)"
                required
              />

              <Alert severity="success" sx={{ mt: 2 }}>
                <strong>Training Officer Benefits:</strong>
                <br />• Priority processing of requests
                <br />• Administrative approval authority
                <br />• Bulk request capabilities
              </Alert>
            </Box>
          )}
        </DialogContent>
